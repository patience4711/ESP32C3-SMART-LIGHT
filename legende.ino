...
// added bluetoothserial funcionallity
// if no wifi connection made, bluetooth is started and we can connect wifi via bluetooth app
// this version ha an infinitive loop for the bluetooth.

// compile with boardversion 1.0.6 with partition scheme minimal SPIFFS otherwise no OTA
// compile with boardversion 1.0.11 with partition scheme minimal SPIFFS otherwise no OTA works also
